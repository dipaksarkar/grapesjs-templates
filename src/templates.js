    ...
    data: {
      ...
      styles: [
        ...
        },
        {
          ...
          style: {
            'font-family': 'Arial, Helvetica, sans-serif',
            'background-image': 'linear-gradient(rgba(59, 130, 245, 0.11), white 14%)',
                        ...
                        components: [
                          ...
                          },
                          {
                            ...
                            components: [
                              {
                                type: 'textnode',
                                content: 'Put here the text describing why your features are\n        '
                              },
                              {
                                tagName: 'span',
                                type: 'text',
                    ...
                    components: [
                      {
                        ...
                        components: [
                          ...
                          },
                          {
                            ...
                            components: [
                              {
                                classes: ['gjs-grid-column', 'testimonial-item'],
                                attributes: {
                                  id: 'inea73'
                                },
                                components: [
